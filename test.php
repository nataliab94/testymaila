...
<?php
    ...
    //$subject = 'Darmowy, świetny e-book - HTML na przykładach';
    $subject = '=?UTF-8?B?'.base64_encode('Darmowy, świetny e-book - HTML na przykładach').'?=';

    //$message = '<p>Dzień dobry!'."\r\n\r\n".'Oto link do naszego świetnego e-booka: <a href ="https://domena.pl/ebook.pdf">POBIERZ EBOOKA</a></p>';
    $message = base64_encode('<p>Dzień dobry!'."\r\n\r\n".'Oto link do naszego świetnego e-booka: <a href ="https://domena.pl/ebook.pdf">POBIERZ EBOOKA</a></p>');

    $headrers = 'Content-Type: text/plain; charset=utf-8'."\r\n";
